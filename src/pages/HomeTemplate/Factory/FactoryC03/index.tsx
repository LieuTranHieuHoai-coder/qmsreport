...
export default function FactoryC03() {
  ...
  useEffect(() => dispatch(actFetchListData(selectDate ? selectDate?.[0] : today , selectDate ? selectDate?.[1] : today , "QVN", "" , "Factory C03")), [selectDate]);
  useEffect(
    () =>
      dispatch(
        actFetchDefectChart(
        ...
        <div className="row d-flex justify-content-between align-items-center">
          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-8 col-xxl-9">
            ...
            <h2 className="fw-bold w-100 text-center">
              {t("homepage.dashboard.qtyAllFactory3")}
              </h2>
